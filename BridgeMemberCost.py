...
jc = 0 #Sets the joint cost value
plot_initial_layout = 0 #Plot initial layout
text = 0 #Switch to show/hide text on graphs. 1 to show, 0 to hide.

#Running the main function
trussopt(width=40, height=5, st=1, sc = 1, jc =jc, string = 'Case 1 Optimized Truss, jc='+str(jc))
